...
client.user.setGame(`$help | DJ DaM System`,"http://twitch.tv/MC")
...
client.on('message', message => {
    var prefix = "$";
      ...
      if (message.author.id == 511249395128205313) return;
...
client.on('message', msg => {
    if (msg.content === 'كيفكم') {
      msg.reply('**تمام الحمد لله انت كيفك :two_hearts: **');
    }
  });

client.on('message', msg => {
    if (msg.content === 'هلا') {
      msg.reply('**هلا فيك:two_hearts:**');
    }
  });

client.on('message', msg => {
    if (msg.content === 'كيفك') {
      msg.reply('**تمام الحمد لله انت كيفك**');
    }
  });


client.on('message', msg => {
    if (msg.content === 'في احد') {
      msg.reply('**يب تفضل:two_hearts:**');
    }
  });
...
client.on('message', msg => {
    if (msg.content === 'مرحبا') {
      msg.reply('**مراحب  ياهلا:two_hearts:**');
    }
  });
...
client.on('message', msg => {
    if (msg.content === 'باك') {
      msg.reply('**ولكممم باك ياعسل:two_hearts:**');
    }
  });
